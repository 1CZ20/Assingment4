...
//  Assingment4
//
//  Created by user228140 on 10/31/22.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func positiveNegativeTap(_ sender: Any) {
    ...
    @IBAction func equalsTap(_ sender: Any) {
        ...
        if(validInput() {
            ...
            let checkedWorkingsForPercent = workings.replacingOccurences(of: "%", with: "*0.01")
